package com.luffy.indicatorlib.buildins.commonnavigator.indicators;
...
import com.luffy.indicatorlib.FragmentContainerHelper;
 ...
 *
 * @desc 包裹住内容区域的指示器，类似天天快报的切换效果，需要和IMeasurablePagerTitleView配合使用
 */
